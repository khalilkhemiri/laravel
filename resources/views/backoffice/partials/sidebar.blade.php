<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bold ms-2">Agriculture urbaine</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <!-- Pages -->
            <li class="menu-item">
              <a href="/admin/advices" class="menu-link ">
                <i class="menu-icon tf-icons bx bx-dock-top"></i>
                <div class="text-truncate" data-i18n="Account Settings">Advices</div>
              </a>
              <a href="/admin/ratings" class="menu-link ">
                <i class="menu-icon tf-icons bx bx-dock-top"></i>
                <div class="text-truncate" data-i18n="Account Settings">Ratings</div>
              </a>


    <a href="{{ route('gardens.index.admin') }}" class="menu-link">
    <i class="menu-icon tf-icons bx bx-leaf"></i>
    <div class="text-truncate" data-i18n="Basic">Jardin</div>
    </a>

    <a href="{{ route('evenements.index.admin') }}" class="menu-link">
    <i class="menu-icon tf-icons bx bx-party"></i>
    <div class="text-truncate" data-i18n="Basic">Événement</div>
    </a>


    <a href="{{ route('evenements.calendrier.admin') }}" class="menu-link">
        <i class="menu-icon tf-icons bx bx-calendar-event"></i>
        <div class="text-truncate" data-i18n="Basic">Calendrier</div>
    </a>
    ...
    <a href="/admin/plants" class="menu-link">
    <i class="menu-icon tf-icons bx bx-party"></i>
    <div class="text-truncate" data-i18n="Basic">plants</div>
    </a>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="pages-account-settings-account.html" class="menu-link">
                    <div class="text-truncate" data-i18n="Account">Ratings</div>
                  </a>
                </li>
                <li class="menu-item">
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div class="text-truncate" data-i18n="Authentications">Ratings</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
